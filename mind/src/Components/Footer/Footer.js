...
const Footer = () => {
    return (
        <div style={{ backgroundImage: `url(${backgroundImg})`, objectFit:'fill'  }} className={"footer mt-5"}>
              ...
              <div  className={"footer_top  container"}>
                 <div className={'row contact_infos justify-content-between '}>
                     <div  className={'contact_info col-lg-3 col-sm-12   py-5'}>
                         <ul>
                             <h4>Contact Info</h4>
                             <li><i className={'fa-solid fa-phone me-2 py-2'}/> <a href={'tel: +994703766983'}>+994703766983</a></li>
                             ...
                             <li><i className={'fa-solid fa-heart me-3 py-2'}/>
                                 <i className={'fa-brands fa-facebook me-3 py-2'}/>
                                 <i className={'fa-brands fa-twitter me-3 py-2'}/>
                                 <i className={'fa-brands fa-linkedin me-3 py-2'}/>
                                 <i className={'fa-brands fa-telegram me-3 py-2'}/>
                                 <i className={'fa-brands fa-youtube me-3 py-2'}/>
                                 <i className={'fa-brands fa-pinterest me-3 py-2'}/>
                             </li>
                         </ul>
                     </div>
